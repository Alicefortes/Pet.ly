...
function CardAnimal(props) {
  ...
  return (
    <Pressable
      onPress={() => navigation.navigate("PetDetails", { petId: props.pet.id })}
      borderRadius={12}
      borderWidth="1"
      borderColor="#E54300"
      w={150}
    ...
    >
      <Center h="100%">
        ...
        <Text fontFamily="Mont" color="#E54300" mt={3} textSize="lg" bold>
          {props.pet.name}
        </Text>
        <Text fontFamily="Mont" mb={3} textSize="lg">
          {props.pet.specie}
        </Text>
      </Center>
    </Pressable>
...
function CardAddAnimal() {
  ...
  return (
    <Pressable
      onPress={() => navigation.navigate("CadPets")}
      w={150}
      h="100%"
      borderRadius="md"
    ...
    >
      ...
      >
        <Icon
          ...
          paddingBottom="50"
        />
        <Heading fontFamily="Mont" padding={3} color="#FFFFFF" size="sm">
          Adicionar novo pet
        </Heading>
      </Center>
    </Pressable>
  ...
  return (
    <>
      <HStack justifyContent="space-between" alignItems="center">
        <Heading fontFamily="Nunito" fontSize="xl" color="#003DA5" my={5}>
          Seus Pets
        </Heading>
        <Pressable
          flexDirection="row"
          ...
          onPress={() => navigation.navigate("Pets")}
        >
          <Heading color="#FE5000" fontFamily="Mont" size="sm">
            Ver todos
          </Heading>
          <Icon
            size="6"
    ...
    <View flex={1} bg="#FE5000">
      ...
      <Box h="100%" bg="white" borderTopRadius="md">
        <View w="100%" py={3} px={5}>
          <Heading color="#003DA5" fontFamily="Nunito" marginBottom={5}>
          ...
          {notes == null ? (
            ...
            <Center w="100%">
              <Text mb={10}>Você ainda não tem eventos para seus pet</Text>
            </Center>
          ) : (
