    ...
    <Box flex={1} bg="#FE5000">
      ...
      <Box Box h="100%" w="100%" borderTopRadius="md" bg="white">
        <HStack w="95%" margin="5%" space={5} alignItems="center">
          ...
          <VStack>
            <Heading paddingBottom={1} fontFamily="Nunito" color="Black">
            ...
            <Box w="100%" marginBottom={5}>
              <HStack justifyContent="space-between" alignItems="center">
                <Box alignItems="center" flexDirection="row">
                  ...
                  <Text fontFamily="Mont" marginLeft={5}>
                    Conta
                  </Text>
                </Box>
                <Pressable>
                  <HStack alignItems="center">
                    <Text marginRight={2} fontFamily="Mont">
                ...
                <Box>
                  ...
                  >
                    <AlertDialog.Content>
                      ...
                      <AlertDialog.Header fontFamily="Mont">
                        Logout
                      </AlertDialog.Header>
