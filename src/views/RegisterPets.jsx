    ...
    <>
      {isLoading ? (
        <VStack space={2} h="100%" alignItems="center" justifyContent="center">
          ...
          />
          <Heading fontSize="md">Criando o perfil do seu Pet</Heading>
        </VStack>
      ) : (
        <>
          <Box flexDirection="column" justifyContent="center" textAlign="left">
            <Heading size="md" fontFamily="Mont" py={3}>
              Configurando o Perfil do seu Pet
            </Heading>
          </Box>
          <FormControl isRequired pt={5}>
            ...
            <Select
              ...
              onValueChange={(itemValue) =>
                setFormData({ ...formData, specie: itemValue })
              }
            >
            ...
            <Heading size="sm" fontFamily="Mont" pt={3}>
            ...
            <HStack justifyContent="space-between" w="100%">
              ...
              <VStack w="45%">
                ...
                <Select
                  ...
                  py={3}
                  onValueChange={(itemValue) =>
                    setFormData({ ...formData, ageMonths: itemValue })
                  }
                >
