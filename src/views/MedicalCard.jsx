            ...
            <HStack alignItems="center">
              ...
              <VStack marginLeft={3}>
                ...
                <Text fontFamily="Mont">
                  {route.params.pet.ageYears} Anos e{" "}
                  {route.params.pet.ageMonths} meses
                </Text>
              </VStack>
            </HStack>
        ...
        <Center>
          <Box w="100%">
            ...
            <Center>
              <Pressable
                onPress={() =>
                  navigation.navigate("medicacao", { pet: route.params.pet })
                }
                padding={7}
                marginBottom={3}
                w="100%"
                ...
                backgroundColor="#FE5000"
              >
                <Heading fontFamily="Mont" size="sm" color="white">
                  Medicações
                </Heading>
                <Icon
                  as={MaterialIcons}
              ...
              <Pressable
                padding={7}
                onPress={() =>
                  navigation.navigate("vacina", { pet: route.params.pet })
                }
                marginBottom={3}
                w="100%"
                flexDirection="row"
                ...
                backgroundColor="#FE5000"
              >
                <Heading size="sm" fontFamily="Mont" color="white">
                  Vacinas
                </Heading>
                <Icon
                  as={MaterialIcons}
